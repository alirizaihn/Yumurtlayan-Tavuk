        ...
        while(isRunning){
            ...
            if(canvas != null){
                synchronized (surfaceHolder){
                    AppConstants.getGameEngine().updateLevel(canvas);
                    AppConstants.getGameEngine().updateAndDrawBackgroundImage(canvas);

                 AppConstants.getGameEngine().updateDrawBasketImage(canvas);

                    AppConstants.getGameEngine().updateDrawCatImage(canvas);

                    AppConstants.getGameEngine().updateAndDrawEggImage(canvas);
                    AppConstants.getGameEngine().updateAndDrawChickenImage(canvas);
